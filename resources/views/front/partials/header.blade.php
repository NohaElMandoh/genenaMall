<header>
    ...
    <li>
                                    ...
                                    <li> <a title="Wishlist" class="hidden-xs socialss" rel="alternate"
                                            hreflang="{{ 'ar' }}"
                                            href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}"> {{__('home.AR')}}</a>
                                    </li>
                    ...
                    <div class="col-xs-12 hidden-xs col-lg-4 col-md-4 col-sm-4">
                        ...
                        <div class="jtv-top-links">
                            <div class="links">
                                <ul>
                                    <li class="linkGetting"><a class="Getting" href="#">{{__('home.Getting here')}}</a></li>
                                    <li> <a title="My Account" href="{{$website->facebook}}" class="socialss  "><span class="hidden-xs"><i
                                                    class="fa fa-facebook" aria-hidden="true"></i></span></a> </li>
                                    <li> <a title="My Account" href="{{$website->instagram}}" class="socialss  "><span class="hidden-xs"><i
                                                    class="fa fa-instagram" aria-hidden="true"></i></span></a> </li>
                                    <li> <a title="My Account" href="{{$website->twitter}}" class="socialss  "><span class="hidden-xs"><i
                                                    class="fa fa-twitter" aria-hidden="true"></i></span></a> </li>
                                    <li> <a title="My Account" href="{{$website->youtube}}" class="socialss  "><span class="hidden-xs"><i
                                                    class="fa fa-youtube" aria-hidden="true"></i></span></a> </li>
                                </ul>
                            </div>
                        </div>
