                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <div class="leftbarfixed">
                            <div class="serach">
                                ...
                                <input type="hidden"  id='type' name='type' value='offer'>
                                <button type="submit">   <span class="iconn"><svg width="17" height="18" viewBox="0 0 48 50"
                            ...
                            <div class="listlinkssear">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('offer') }}">{{ __('item.All') }}<span
                                    ...
                                    @if (!empty($categories))
                                        @foreach ($categories as $category)
                                            ...
                                            <li>
                                                <a href="{{ route('offersByCategory', [$category->id, 0]) }}">{{ $category->name_en }}
                                                    <span class="numn">
                                                        @php
                                                            $count_items = 0;
